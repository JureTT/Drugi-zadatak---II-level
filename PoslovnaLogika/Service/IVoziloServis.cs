...
namespace PoslovnaLogika.Service
{
    ...
    {        
        ...
        (List<VoziloMarka>, int) DohvatiMarke(ISorter sorter, IFilter filter, INumerer stranica);
        ...
        (List<VoziloModel>, int) DohvatiModele(ISorter sorter, IFilter filter, INumerer stranica);
